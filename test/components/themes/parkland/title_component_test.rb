...
class Themes::Parkland::TitleComponentTest < ViewComponent::TestCase
  test "renders when title is present" do
    ...
    assert_match(
      /Recent News/,
      render_inline(Themes::Parkland::TitleComponent.new(title: title, sub_title: sub_title)).to_html
    )
